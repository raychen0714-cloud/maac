...
def load_settings():
    ...
    default_data = {
        "etfs": [
            ...
            {"symbol": "0056.TW", "name": "元大高股息", "shares": 3000, "cost": 41.45, "manual_pnl": -1802},
            {"symbol": "00646.TW", "name": "元大S&P500", "shares": 7200, "cost": 44.54, "manual_pnl": 184605},
            {"symbol": "00903.TW", "name": "富邦元宇宙", "shares": 2000, "cost": 14.33, "manual_pnl": 7094},
            {"symbol": "00940.TW", "name": "元大台灣價值高息", "shares": 13000, "cost": 9.88, "manual_pnl": 5385}
        ]
    }
...
for m in month_order:
    if g_months[m]["detail"]:
        for d in g_months[m]["detail"]:
            detail_rows.append({"月份": m, "股票來源": d["股票"], "預估領息金額": f"${d['金額']:,}"})
